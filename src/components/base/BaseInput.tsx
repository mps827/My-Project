  ...
  return (
    <>
      {colaps && props.rightIcon ? (
        <div>
          <div
            className=" flex items-center justify-center py-2 px-2 border-2 border-slate-300 dark:border-Dark-Grey text-slate-300 dark:text-slate-50 rounded-full cursor-pointer "
            onClick={() => {
              setColaps(false);
            }}
          >
          ...
          <div
            className={
              ...
              (props.underlineBorder
                ? " border dark:border-Raisin-Black "
                : " ") +
              " bg-white dark:bg-Approx-Nero rounded-3xl relative"
            }
            ref={inputRef}
          >
            {props.rightIcon && (
            ...
            <input
              className={
                ...
                (props.noColor
                  ...
                  : " text-gray-900 ") +
                (props.underlineBorder
                  ? "  border-none bg-White dark:bg-Approx-Nero dark:focus:ring-Dove-Gray"
                  : " border border-gray-300 dark:border-Dark-Grey focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500 ") +
                (props.noColor || props.underlineBorder
                  ? " bg-none-color dark:bg-none-color "
                  : " bg-gray-50 dark:bg-Raisin-Black ") +
