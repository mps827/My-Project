  ...
  return (
    <div className={" flex flex-col items-center gap-6 p-6 "}>
      ...
      <div className={"flex flex-row items-start gap-32 "}>
        <div className={" bg-white dark:bg-Raisin-Black " + classes.features}>
          {/* propertyArea */}
          <div
            className={
              " bg-Pale-White dark:bg-Approx-Nero " + classes.featureCard
            }
          >
            ...
            <div className={" flex items-start w-2/3 "}>
              <BaseSelectInput
                handleselectedOption={(e) => inputOnChangeHandler("propertyArea", e)}
                options={[
                  { title: "تجریش", value: "1" },
          ...
          >
            ...
            <div className={" flex items-start w-2/3 "}>
              <BaseSelectInput
                handleselectedOption={(e) => inputOnChangeHandler("space", e)}
                options={[
          ...
          >
            ...
            <div className={" flex items-start w-2/3 "}>
              <BaseSelectInput
                handleselectedOption={(e) => inputOnChangeHandler("room", e)}
                options={[
                  { title: "1", value: "1" },
                  { title: "2", value: "2" },
                  { title: "3", value: "3" },
          ...
          >
            ...
            <div className={" flex items-start w-2/3 "}>
              <BaseSelectInput
                handleselectedOption={(e) => inputOnChangeHandler("floor", e)}
                options={[
                  { title: "اول", value: "1" },
                  { title: "دوم", value: "2" },
                  { title: "سوم", value: "3" },
        ...
        <div className={" bg-white dark:bg-Raisin-Black " + classes.optionBox}>
