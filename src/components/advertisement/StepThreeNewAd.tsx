...
const StepThreeNewAd = () => {
  ...
  return (
    <div className={" bg-Pale-White dark:bg-Raisin-Black " + classes.formLayout}>
      <AdvertisementFormSubHeader />
      <div className={"flex flex-row items-center gap-20  "}>
        <div className={" bg-white dark:bg-Approx-Nero " + classes.detailBox}>
          <div className={" bg-Pale-White dark:bg-Raisin-Black " + classes.featureCard}>
