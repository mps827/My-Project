...
import { filterOptions, Range } from "@/types/sharedTypes";
...
const AdvertisementFilterBox: React.FC<AdvertisementFilterBoxProps> = () => {
  ...
  return (
    <div
      className={classes.filtersContainer + " bg-white dark:bg-Raisin-Black z-0"}
    >
          ...
          {filterOptions.map((obj, index) => {
            return (
              <div
                ...
                className={
                  classes.filterBox +
                  (search.selectedFilters.includes(obj.key)
