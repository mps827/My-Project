...
import AdvertisementFilterBox from "./AdvertisementFilterBox";
import AdvertisementFormSubHeader from "./AdvertisementFormSubHeader";
const AdvertisementStepper = dynamic(() => import("./AdvertisementStepper"), {
  ssr: false,
});
  ...
  return (
    <>
      ...
      <div className={classes.adBox}>
        ...
        <div className={"bg-white dark:bg-Raisin-Black " + classes.categoryBox}>
              ...
              <div
                ...
                className={
                  (selectedCategory === category
                    ...
                    : "bg-Pale-White dark:bg-Approx-Nero ") + classes.categoryCard
                }
                onClick={() => {
